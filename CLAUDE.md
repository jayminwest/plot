...
<!-- seeds-onboard:v0.4.6 -->
<!-- seeds-onboard-schema:5 -->

This project uses [Seeds](https://github.com/jayminwest/seeds) v0.4.6 for git-native issue tracking.
...
<!-- mulch-onboard:v0.10.1 -->

This project uses [Mulch](https://github.com/jayminwest/mulch) v0.10.1 for structured expertise management.
